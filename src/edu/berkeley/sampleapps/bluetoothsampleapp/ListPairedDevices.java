...
public class ListPairedDevices extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        MainActivityBluetoothSampleApp.bluetoothSerivceHandler.getPairedDevices(MainActivityBluetoothSampleApp.listPairedDevices);
        
        //String string = new String();        
        //string = (String)bundle.getSerializable("LIST_PAIRED_DEVICES");
        //Log.e(TAG,string);
